...
class CraftsManPipeline():
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        if not os.path.isdir(pretrained_model_name_or_path):
            ...
            if os.path.exists(os.path.join(pretrained_model_name_or_path, "model.bin")):
                ckpt_path = os.path.join(pretrained_model_name_or_path, "model.bin")
            else:
        ...
        system.load_state_dict(
            ckpt["state_dict"] if "state_dict" in ckpt else ckpt, strict=True
        )
